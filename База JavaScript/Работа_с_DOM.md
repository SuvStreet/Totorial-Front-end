...
- [Что такое DOM-дерево](#что_такое_DOM_дерево)
- [Получение элементов DOM](#получение_элементов_DOM)
  ...
  - `querySelector()`
  - `querySelectorAll()`
- [Свойства и методы HTML-элементов](свойства_и_методы_HTML_элементов)
  - `id`
  - `className`
  - `innerText`
  - `innerHTML`
  - `children`
- [Data-атрибуты](data_атрибуты)
  - `dataset`
- [Стили](стили)
  - `style`
- [Создание HTML-элементов и добавление их в DOM](создание_HTML_элементов_и_добавление_их_в_DOM)
  - `createElement()`
...
<h2><a name="что_такое_DOM_дерево">Что такое DOM-дерево</a></h2>
...
<h2><a name='свойства_и_методы_HTML_элементов'>Свойства и методы HTML-элементов</a></h2>
...
<h2><a name='data_атрибуты'>Data-атрибуты</a></h2>
...
<h2><a name='создание_HTML_элементов_и_добавление_их_в_DOM'>Создание HTML-элементов и добавление их в DOM</a></h2>
