...
По умолчанию предлагают сохранить ключ в файле под именем *id_rsa*. Мы можем заменить это на своё имя. Назавём файл именем удалённого репозитория.
...
> Рис.13 **"Копируем ссылку для клонирования удолённого репазитория"**
